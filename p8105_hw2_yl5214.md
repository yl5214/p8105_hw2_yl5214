...
There are 845 observations in the merged dataset. The key variables are
...
cleaner. There are 2435 observations in the merged dataset. The key
variables are id, time, value.
...
\##Describe the resulting dataset There are 471 observations in the
merged dataset. The key variables are id, baseline, time_2, time_4,
time_6, time_8, current_age, sex, education, apoe4, age_at_onset.
